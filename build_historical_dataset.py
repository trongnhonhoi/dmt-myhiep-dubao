...
# Script to write the full historical meter dataset for My Hiep Solar Plant
CSV_PATH = os.path.join(os.path.dirname(__file__), "historical_meter_daily_energy.csv")

def parse_and_export(raw_data_str: str):
    records = []
