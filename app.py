...
with tab_multi:
    ...
    with subtab_2d:
        ...
        fig_2d.add_hline(y=ac_capacity, line_dash="dash", line_color="#EF4444", annotation_text=f"Trần Inverter {ac_capacity:.3f} MW")
        fig_2d.update_layout(
            title=f"<b>Biểu Đồ Công Suất {target_title} (Quy Chuẩn EVN / A0 / A3)</b>", 
